  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="w-64 bg-green-800 dark:bg-gray-800 text-white flex flex-col transition-all shadow-xl">
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <a href="dashboard.php" class="block py-3 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-gray-700 flex items-center transition-all bg-green-700 dark:bg-gray-700">
          <i class="fas fa-home mr-3 w-5"></i>
          <span>Dashboard</span>
        </a>
        <a href="cropchart.php" class="block py-3 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-gray-700 flex items-center transition-all">
          <i class="fas fa-database mr-3 w-5"></i>
          <span>Crop Chart</span>
        </a>
        <a href="farmers.php" class="block py-3 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-gray-700 flex items-center transition-all">
          <i class="fas fa-users mr-3 w-5"></i>
          <span>Farmers</span>
        </a>
        <a href="reports.php" class="block py-3 px-4 rounded-lg hover:bg-green-700 dark:hover:bg-gray-700 flex items-center transition-all">
    ...
    <main class="flex-1 overflow-y-auto">
      <div class="p-4 md:p-6 lg:p-8">
        ...
        <!-- Add/Update Form -->
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 mb-6 transition-all border border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between mb-4">
            ...
            <button id="resetBtn" onclick="resetForm()" class="px-3 py-1 text-sm bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-all hidden">
          ...
          <form id="userForm" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input type="text" id="regno" placeholder="Enter registration number" required
                class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" id="latitude" placeholder="e.g., 7.2345" required
                class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Longitude *</label>
              <input type="text" id="longitude" placeholder="e.g., 79.8612" required
                class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Telephone *</label>
              <input type="tel" id="tel" placeholder="e.g., 0771234567" required
                class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
            </div>
            <div class="sm:col-span-2 lg:col-span-3">
              <button type="submit" class="w-full px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all font-semibold shadow-md hover:shadow-lg">
